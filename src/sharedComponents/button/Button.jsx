const Button = ({ btnText }) => {
  return (
    <button className="btn shadow-lg shadow-[#6a9995] hover:shadow-[#eeab8f] mt-10 border border-[#07332F] relative inline-flex items-center justify-center px-8 py-3.5 overflow-hidden font-mono  tracking-tighter text-[#07332F] bg-[#fdc4ac] rounded-lg group">
